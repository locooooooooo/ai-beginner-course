...
但它不是绝对正确的数据库。它会误解上下文，会编造看似合理但不真实的信息，也会在缺少文件、报错、环境信息时给出空泛答案。所以新手最重要的不是背模型名，而是学会给清楚的任务、足够的上下文和明确的验收标准。

### 2. Agent 是“会动手的大模型系统”

普通聊天模型更像“回答问题的人”。Agent 更像“带工具的执行者”。它通常由五部分组成：
...
### 4. OpenClaw：更像“常驻在你电脑和聊天软件里的个人助理”
