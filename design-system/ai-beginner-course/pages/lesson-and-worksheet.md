# Lesson And Worksheet Overrides

Applies to:

- `lessons/*.html`
- `lessons/*-worksheet.html`
- `chapters/chapter-*.html`

## Lesson Pages

- Hero labels must use the sticker style.
...
- 390px viewport must show the first nav item from the left.
- No horizontal scroll should be possible.
- Long Chinese headings may wrap; do not reduce font with viewport units.
